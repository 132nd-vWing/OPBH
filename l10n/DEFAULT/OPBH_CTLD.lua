...
ctld.maximumSearchDistance = 300 -- max distance for troops to search for enemy
ctld.maximumMoveDistance = 15 -- max distance for troops to move from drop point if no enemy is nearby
...
ctld.pickupZones = {
    { "Al Dhafra", "none", -1, "yes", 0 },
	{ "Al Minhad", "none", -1, "yes", 0 },
	...
	{ "CTLDZone1", "none", -1, "yes", 0 },
	{"USS Tarawa", "none", -1, "yes", 0 },
    ...
    if type(_countOrTemplate) == "table" then
        ...
        if _countOrTemplate.mortar then
		 ...
		 if _countOrTemplate.JTAC then
            _troops = ctld.insertIntoTroopsArray("M1025 HMMWV",_countOrTemplate.JTAC,_troops)
        end
