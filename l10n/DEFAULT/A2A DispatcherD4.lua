...
DetectionSetGroup:FilterPrefixes( { "EWR" , "SAM1 - SA-10 SCUD", "SAM4 - SA-10 Kerman"} )
DetectionSetGroup:FilterStart()
CAPZone = ZONE:New( "CAPshiraz", "CAPlar","CAPkerman", "CAPabbas" ) --is ignored
...
A2ADispatcher:SetSquadron( "ShirazSqn", "Shiraz Intl", ("Bogey-Shiraz") )
...
--LAR CAP (from Shiraz)
if LarCap ==true then
A2ADispatcher:SetSquadron( "ShirazSqn2", "Shiraz Intl", ("Bogey-Lar") )
...
A2ADispatcher:SetSquadronTanker("ShirazSqn2", "IranRefueller#001") 
...
A2ADispatcher:SetSquadron( "KermanSqn", "Kerman", ("Bogey-Kerman") )
...
A2ADispatcher:SetSquadron( "AbbasSqn", "Lar", ("Bogey-Abbas") )
...
--JIROFT GCI ONLY
jiroftOn = math.random(60,100)
if jiroftOn < 50 then

A2ADispatcher:SetSquadron( "JiroftSqn", "Jiroft", ("Bogey-Jiroft") , JiroftGCINumbers)
