...
awacs1 = SPAWN:New("AWACS FOCUS #IFF:5002FR")
...
awacs2 = SPAWN:New("AWACS MAGIC #IFF:5001FR")
...
awacs3 = SPAWN:New("EWR IRAN AWACS Kerman Shiraz")
...
_TANKER_UNITS = {
  ...
  {NAME='TEX_KC-135_TEXACO #IFF:5006FR', TACAN=13 },
...
AWACS_Tankers  = SET_GROUP:New():FilterPrefixes({"AWACS FOCUS #IFF:5002FR", "AWACS MAGIC #IFF:5001FR", "EWR IRAN AWACS Kerman Shiraz", "SHL_KC-135_MPRS_SHELL #IFF:5003FR", "SHL2_KC-135_MPRS_ARCO #IFF:5005FR","TEX_KC-135_TEXACO #IFF:5004FR","IranRefueller","TEX_KC-135_TEXACO #IFF:5006FR"}):FilterStart()
